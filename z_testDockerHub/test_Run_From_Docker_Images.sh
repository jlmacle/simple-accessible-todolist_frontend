...
sudo docker service create --network atl-network --hostname frontend --publish 4200:80 --name atl-front-end jlmacle/atl-front-end:v0.9

sleep 10 

chromium-browser http://127.0.0.1:4200
