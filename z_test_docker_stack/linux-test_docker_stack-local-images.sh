...
echo "**** Waiting for the built of the atl-network. Might take time on an old computer."
sleep 5

echo "* Docker stack deploy."
sudo docker stack deploy -c ../z_docker_compose_files/docker-compose-stack_local-images.yml stack
sleep 120
echo "**** Waiting for the stack to start. The back-end may take some time to start."
